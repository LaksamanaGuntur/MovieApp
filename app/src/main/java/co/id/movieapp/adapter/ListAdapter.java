package co.id.movieapp.adapter;
...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mTxtTitle.setText(resultData.getTitle());
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (ResultData resultData : mResultData) {
                        if (resultData.getTitle().toLowerCase().contains(charString) ||
                                resultData.getOriginalTitle().toLowerCase().contains(charString)) {
